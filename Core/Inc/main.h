...
#define cup_med_Pin GPIO_PIN_0
#define cup_med_GPIO_Port GPIOC
#define cup_high_Pin GPIO_PIN_1
#define cup_high_GPIO_Port GPIOC
#define rez_med_Pin GPIO_PIN_2
#define rez_med_GPIO_Port GPIOC
#define rez_high_Pin GPIO_PIN_3
#define rez_high_GPIO_Port GPIOC
